...
namespace Cityinfo.API.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public class AutheticationRequestBody
        {
        ...
        public ActionResult<string> Authenticate(AutheticationRequestBody authenticationRequestBody)
        {
        ...
        {
            return new CityInfoUser(1, username ?? "", "kani", "dockx", "Dharmapuri");
        }
    }
}
